...
const styles = StyleSheet.create({
  ...
  summary: { backgroundColor: "#16A34A", borderRadius: 14, padding: 18, marginBottom: 16 },
  heading: { color: "#fff", fontSize: 26, fontWeight: "bold", marginBottom: 8 },
  summaryText: { color: "#DCFCE7", fontSize: 15, marginTop: 3 },
  card: { backgroundColor: "#fff", borderRadius: 12, padding: 16, marginBottom: 12, elevation: 2 },
  cardHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  cardTitle: { fontSize: 18, fontWeight: "bold" },
  status: { color: "#166534", backgroundColor: "#DCFCE7", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10, fontSize: 12, fontWeight: "600" },
  date: { color: "#6B7280", fontSize: 13, marginTop: 4, marginBottom: 10 },
  detail: { flexDirection: "row", alignItems: "flex-start", marginTop: 9 },
  detailLabel: { width: 78, color: "#4B5563", fontWeight: "600", marginLeft: 8 },
